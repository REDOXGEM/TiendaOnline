        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UrlPhotoUser = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DataSale", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DataSale_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DataSale_Ventas_VentaId",
                        column: x => x.VentaId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VentaTemporales", x => x.Id);
                    table.ForeignKey(
                        name: "FK_VentaTemporales_AspNetUsers_UsuarioId",
                        column: x => x.UsuarioId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_VentaTemporales_Productos_ProductoId",
                        column: x => x.ProductoId,
                        principalTable: "Productos",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DataSale_ProductoId",
                table: "DataSale",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_DataSale_VentaId",
                table: "DataSale",
                column: "VentaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VentaTemporales_ProductoId",
                table: "VentaTemporales",
                column: "ProductoId");

            migrationBuilder.CreateIndex(
                name: "IX_VentaTemporales_UsuarioId",
                table: "VentaTemporales",
                column: "UsuarioId");
        }
